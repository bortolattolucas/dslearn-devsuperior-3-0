...
public class Section implements Serializable {
    ...
    // bidirecional, ou seja, o Resource tbm conhece as Sections
    @ManyToOne
    @JoinColumn(name = "resource_id")
    private Resource resource;

    // unidirecional, ou seja, apenas a section principal conhece seu pre-requisito
    // logo, apenas esse mapeamento é necessario
    @ManyToOne
